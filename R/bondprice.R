...
function(){
  ...
  my.panel <- rp.control("Bond Price", frequency="quarterly",couprate= 8,discrate=10, maturity = 10)
  #   rp.slider(panel, discrate, 1,30,my.redraw, title = "Required Rate")
  ...
  #   rp.slider(my.panel,couprate,1,20,my.redraw, title = "Coupon Rate")
