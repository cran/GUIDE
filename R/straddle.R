...
function(){
  ...
  my.draw <- function(panel) 
  {
    ...
    with(panel, {
      ...
      drawprofits(panel)
      title(paste("Straddle with call and put"))
    })
    panel
  }
  ...
  my.panel <- rp.control(title="Straddle with call and put", k1= 100, k2 = 100, maxprice=200, minprice=0,p1=10,c1=12,longput=FALSE,longcall=FALSE,profit=FALSE)
