...
function(){
  ...
  rp.radiogroup(my.panel,variable=opttype,labels=c("Call","Put"),values=c("Call","Put"),action=my.redraw,title="Option Type")
  rp.radiogroup(my.panel,variable=plottype,title="Plot Type", labels=c("Payoff","Profit & Loss"),values=c("Payoff","Profit & Loss"),action=my.redraw)
